 ...
 */
'use strict';
app.controller('coinSecondsKillSuccessCtrl',['$scope','$http','$rootScope','$ionicModal',function($scope,$http,$rootScope,$ionicModal){
  document.title="货蛮好网-金币秒杀提交成功";
