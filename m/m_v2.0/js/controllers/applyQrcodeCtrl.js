 ...
 */
'use strict';
app.controller('applyQrcodeCtrl', ['$scope', '$rootScope', '$http', '$location', '$interval', 'Signature', function ($scope, $rootScope, $http, $location, $interval, Signature) {
  ...
  // var timer1;
  // $scope.sr = function (event) {
  //   $scope.timer1 = $interval(function () {
  //     $(event.target).scrollIntoView(false);
  //   }, 100);

  // }
  // $scope.nosr = function (event) {
