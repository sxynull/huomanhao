...
app.controller('highListCtrl', function ($scope, $http, $ionicScrollDelegate, Signature,$rootScope) {
   document.title="货蛮好网-高价值";
  ...
  $scope.getRestaurants = function () {
    $scope.page++;  // 页数++
    $scope.url = Signature.login("/high/value/goods?sort_type=" + $scope.sort_type + "&sort_enum=" + $scope.sort_enum + "&current_page="+$scope.page+"&page_size=10");
